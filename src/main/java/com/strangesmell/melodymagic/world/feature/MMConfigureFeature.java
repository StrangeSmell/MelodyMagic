...
import static com.strangesmell.melodymagic.MelodyMagic.MORNING_GLORY;

public class MMConfigureFeature {
    public static final ResourceKey<ConfiguredFeature<?, ?>> MORNING_GLORY_KEY = registerKey("morning_glory");
